...
# Terraform configuration is generated by Terragrunt
# See terragrunt.hcl for provider configuration
# Provider block is generated automatically by Terragrunt
...
module "lambda_rule_executor" {
  ...
  source_path = data.archive_file.lambda_rule_executor.output_path
  output_path = data.archive_file.lambda_rule_executor.output_path
  source_code_hash = data.archive_file.lambda_rule_executor.output_base64sha256
...
module "lambda_api_gateway" {
  ...
  source_path = data.archive_file.lambda_api_gateway.output_path
  output_path = data.archive_file.lambda_api_gateway.output_path
...
module "glue" {
  ...
  script_path = "s3://${local.code_bucket}/${aws_s3_object.glue_bulk_validator.key}"
